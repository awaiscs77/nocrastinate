...
class Goal5Screen extends StatefulWidget {
  ...
  @override
  _Goal5ScreenState createState() => _Goal5ScreenState();
}
                    ...
                    children: [
                      ...
                      RichText(
                        ...
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(text: 'In your opinion, why was there\nno progress towards your goal?'.tr()),
                          ],
                        ),
                      ),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => Goal6Screen(
                              goalData: widget.goalData,
                              noProgressReason: _textController.text.trim(),
                            ),
                          ),
                        );
                      },
