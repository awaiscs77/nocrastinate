...
import 'package:nocrastinate/Screens/CustomTabbar/Home/MoodScreens/MindPracticeScreens/SelfCompassion/RecogniseEmotionsScreen.dart';
import 'package:nocrastinate/ThemeManager.dart';
import 'package:provider/provider.dart';
import '../../../../../../Manager/MindPracticeManager.dart';
import 'package:easy_localization/easy_localization.dart';

class CriticizeYourselfScreen extends StatefulWidget {
  const CriticizeYourselfScreen({
    Key? key,
  }) : super(key: key);

  @override
  _CriticizeYourselfScreenState createState() => _CriticizeYourselfScreenState();
}

class _CriticizeYourselfScreenState extends State<CriticizeYourselfScreen> {
  ...
  Future<void> _initializePracticeSession() async {
    ...
    if (!practiceManager.hasActiveSession) {
      ...
      final success = await practiceManager.startPractice(
        practiceType: MindPracticeManager.selfCompassionType,
      );
  ...
  Future<void> _handleNext() async {
    ...
    // Update practice data with self criticism
    final success = await practiceManager.updatePracticeData(
      data: {
        'selfCriticism': _textController.text.trim(),
      },
    );
    ...
    if (success) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => RecogniseEmotionsScreen(
            selfCriticism: _textController.text.trim(),
          ),
        ),
      );
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Text(
                                  "What's something you've been criticizing yourself for?".tr(),
                    ...
                    Container(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: (_isValidInput() && !_isLoading) ? _handleNext : null,
