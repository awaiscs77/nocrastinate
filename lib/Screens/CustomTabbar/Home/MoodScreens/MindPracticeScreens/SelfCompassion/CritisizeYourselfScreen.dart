...
class CritisizeYourselfScreen extends StatefulWidget {


  const CritisizeYourselfScreen({
    Key? key,

  }) : super(key: key);

  @override
  _CritisizeYourselfScreenState createState() => _CritisizeYourselfScreenState();
}

class _CritisizeYourselfScreenState extends State<CritisizeYourselfScreen> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Text(
                                "What something you've been criticzing yourself for?".tr(),
