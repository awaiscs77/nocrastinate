...
import 'DidYouThoughScreen.dart';
import '../../PopupQuestionScreen.dart';
import 'package:easy_localization/easy_localization.dart';

class BestPossibleOutcomeScreen extends StatefulWidget {
  final String fearScenario;
  final double initialLikelihood;

  const BestPossibleOutcomeScreen({
    Key? key,
  ...
  @override
  _BestPossibleOutcomeScreenState createState() => _BestPossibleOutcomeScreenState();
}

class _BestPossibleOutcomeScreenState extends State<BestPossibleOutcomeScreen> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Text(
                                "What's the best possible outcome?".tr(),
