...
import 'package:nocrastinate/Screens/CustomTabbar/Home/MoodScreens/MindPracticeScreens/GrowthMindset/TurnChallengeScreen.dart';
import 'package:nocrastinate/ThemeManager.dart';
import 'package:provider/provider.dart';
import '../../../../../../Manager/MindPracticeManager.dart';
import 'package:easy_localization/easy_localization.dart';

class FindingDifficultScreen extends StatefulWidget {
  const FindingDifficultScreen({
    Key? key,
  }) : super(key: key);

  @override
  _FindingDifficultScreenState createState() => _FindingDifficultScreenState();
}

class _FindingDifficultScreenState extends State<FindingDifficultScreen> {
  ...
  Future<void> _initializePracticeSession() async {
    ...
    if (!practiceManager.hasActiveSession) {
      ...
      final success = await practiceManager.startPractice(
        practiceType: MindPracticeManager.growthMindsetType,
      );
  ...
  Future<void> _handleNext() async {
    ...
    // Update practice data with difficulty
    final success = await practiceManager.updatePracticeData(
      data: {
        'difficulty': _textController.text.trim(),
      },
    );
    ...
    if (success) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => TurnChallengeScreen(
            difficulty: _textController.text.trim(),
          ),
        ),
      );
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Text(
                                  "What's something you're finding difficult right now?".tr(),
