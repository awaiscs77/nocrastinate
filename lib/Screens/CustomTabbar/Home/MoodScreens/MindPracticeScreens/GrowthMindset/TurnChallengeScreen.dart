...
import 'package:nocrastinate/Screens/CustomTabbar/Home/MoodScreens/MindPracticeScreens/GrowthMindset/LearnExperienceScreen.dart';
import 'package:nocrastinate/ThemeManager.dart';
import 'package:provider/provider.dart';
import '../../../../../../Manager/MindPracticeManager.dart';
import 'package:easy_localization/easy_localization.dart';

class TurnChallengeScreen extends StatefulWidget {
  final String difficulty;

  const TurnChallengeScreen({
    Key? key,
    required this.difficulty,
  }) : super(key: key);

  @override
  _TurnChallengeScreenState createState() => _TurnChallengeScreenState();
}

class _TurnChallengeScreenState extends State<TurnChallengeScreen> {
  ...
  Future<void> _handleNext() async {
    ...
    // Update practice data with opportunity
    final success = await practiceManager.updatePracticeData(
      data: {
        'opportunity': _textController.text.trim(),
      },
    );
    ...
    if (success) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => LearnExperienceScreen(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Text(
                              "How you can turn this challenge into an opportunity?".tr(),
