...
class LearnExperienceScreen extends StatefulWidget {
  final String difficulty;
  final String opportunity;

  const LearnExperienceScreen({
    Key? key,
  ...
  @override
  _LearnExperienceScreenState createState() => _LearnExperienceScreenState();
}

class _LearnExperienceScreenState extends State<LearnExperienceScreen> {
  ...
  Future<void> _saveGrowthMindsetPractice() async {
    if (_isSaving) return;
    ...
    try {
      ...
      if (practiceManager.hasActiveSession) {
        ...
        final success = await practiceManager.updatePracticeData(data: {
          ...
          'pastLearning': _textController.text.trim(),
        });
        ...
        final practiceId = await MindPracticeService.saveGrowthMindsetPractice(
          difficulty: widget.difficulty,
          opportunity: widget.opportunity,
          pastLearning: _textController.text.trim(),
        );
                          ...
                          Align(
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: "Think of a past challenge where you succeeded through persistence. ".tr(),
                                  ),
                                  TextSpan(
                                    text: "What did you learn from that experience?".tr(),
                                    style: TextStyle(
