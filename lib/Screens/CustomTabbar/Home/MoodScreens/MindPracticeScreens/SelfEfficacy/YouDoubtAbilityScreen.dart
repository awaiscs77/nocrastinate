...
import 'package:nocrastinate/Screens/CustomTabbar/Home/MoodScreens/MindPracticeScreens/SelfEfficacy/ThinkOfTimeScreen.dart';
import 'package:nocrastinate/ThemeManager.dart';
import 'package:provider/provider.dart';
import '../../../../../../Manager/MindPracticeManager.dart';
import 'package:easy_localization/easy_localization.dart';

class YouDoubtAbilityScreen extends StatefulWidget {
  const YouDoubtAbilityScreen({
    Key? key,
  }) : super(key: key);

  @override
  _YouDoubtAbilityScreenState createState() => _YouDoubtAbilityScreenState();
}

class _YouDoubtAbilityScreenState extends State<YouDoubtAbilityScreen> {
  ...
  Future<void> _initializePracticeSession() async {
    ...
    if (!practiceManager.hasActiveSession) {
      ...
      final success = await practiceManager.startPractice(
        practiceType: MindPracticeManager.selfEfficacyType,
      );
  ...
  Future<void> _handleNext() async {
    ...
    // Update practice data with doubt
    final success = await practiceManager.updatePracticeData(
      data: {
        'doubt': _textController.text.trim(),
      },
    );
    ...
    if (success) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => ThinkOfTimeScreen(
            doubt: _textController.text.trim(),
          ),
        ),
      );
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Text(
                                  "What's something you doubt your ability to do?".tr(),
