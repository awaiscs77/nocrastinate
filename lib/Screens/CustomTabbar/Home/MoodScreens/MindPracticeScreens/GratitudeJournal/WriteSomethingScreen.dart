...
class WriteSomethingScreen extends StatefulWidget {
  ...
  @override
  _WriteSomethingScreenState createState() => _WriteSomethingScreenState();
}
...
class _WriteSomethingScreenState extends State<WriteSomethingScreen> {
  ...
  Future<void> _initializePracticeSession() async {
    ...
    if (!practiceManager.hasActiveSession) {
      ...
      final success = await practiceManager.startPractice(
        practiceType: MindPracticeManager.gratitudeJournalType,
      );
  ...
  Future<void> _handleNext() async {
    ...
    // Update practice data with grateful thing
    final success = await practiceManager.updatePracticeData(
      data: {
        'gratefulThing': _textController.text.trim(),
      },
    );
    ...
    if (success) {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => WhyMakesGratefulScreen(
            gratefulThing: _textController.text.trim(),
          ),
        ),
      );
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Text(
                                  "Write something-big or small-that you're grateful for today.".tr(),
